...
describe('AppComponent', () => {
  ...
  describe('#subcribeToNewsSource' , () => {
    beforeEach(() => {
      ...
      appComponent = new AppComponent(newsService);
    });
    it('should return news sources', () => {
      ...
      // Act
      appComponent.subcribeToNewsSource();
      // Expect
      expect(appComponent.sources.length).toEqual(1);
  ...
  describe('#searchArticles', () => {
    ...
    it('should return list of articles', () => {
      ...
      // Act
      appComponent.searchArticlesBySourceId('testing');
      // Axpect
      expect(appComponent.articles.length).toEqual(1);
